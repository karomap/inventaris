{!! Form::open(['route' => 'avatar.upload', 'files' => true, 'class' => 'form-horizontal', 'id' => 'formAvatar']) !!}
  <div class="form-group">
    <div class="col-md-4">
      <img class="img-responsive avatar-view previewAvatar" src="{{ $user->avatar }}" alt="Avatar" title="Avatar">
    </div>
    <div class="col-md-8">
      {!! Form::file('foto') !!}
      <br>
...
{!! Form::model($user, ['route' => ['pengguna.update', $user], 'method' => 'patch', 'class' => 'form-horizontal', 'id' => 'formUser']) !!}
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <div class="btn-group" data-toggle="buttons">
        <label class="btn btn-primary btn-sm {{ $user->role == 'operator' ? 'active' : '' }}">
          {!! Form::radio('role', 'operator') !!} Operator
        </label>
        <label class="btn btn-primary btn-sm {{ $user->role == 'admin' ? 'active' : '' }}">
